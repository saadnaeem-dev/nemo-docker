...
class SttEnFastConformerCtcLarge:
    # Required configs
    model_path: Optional[
        str] = r"C:\\Users\\saadn\\PycharmProjects\\Nvidia-Nemo-Models\\stt_en_fastconformer_ctc_large.nemo"
    audio_dir: Optional[
        str] = r"C:\Users\saadn\PycharmProjects\DATA\295000_wav_files"  # Path to a directory which contains audio files
...
class SttEnSqueezeFormerCtcXsmallLs(SttEnFastConformerCtcLarge):
    model_path: Optional[
        str] = r"C:\\Users\\saadn\\PycharmProjects\\Nvidia-Nemo-Models\\stt_en_squeezeformer_ctc_xsmall_ls.nemo"  # Path to a .nemo file
...
SttEnSqueezeFormerCtcSmallMediumLs [X]
SttEnSqueezeFormerCtcXsmallLs [X]
"""
